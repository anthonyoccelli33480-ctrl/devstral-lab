"""Devstral Lab — vitrine code agentique Mistral."""
...
load_dotenv(_root.parent / "flash-agents" / ".env")

app = FastAPI(title="Devstral Lab", version="1.0.0")
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:5175",
